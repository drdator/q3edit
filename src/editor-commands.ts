...
function createEditorCommands(): CommandDefinition<EditorCommandContext>[] {
  ...
  const commands: CommandDefinition<EditorCommandContext>[] = [
    ...
    { id: 'texture.project-axial', label: 'Project Texture Axial', enabled: hasSelectedFaces, execute: ({ editor }) => editor.projectTexture('axial') },
    { id: 'texture.project-camera', label: 'Project Texture from Camera', enabled: hasSelectedFaces, execute: ({ editor }) => editor.projectTexture('camera') },
    { id: 'texture.project-top', label: 'Project Texture from Top', enabled: hasSelectedFaces, execute: ({ editor }) => editor.projectTexture('top') },
    { id: 'texture.project-front', label: 'Project Texture from Front', enabled: hasSelectedFaces, execute: ({ editor }) => editor.projectTexture('front') },
    { id: 'texture.project-side', label: 'Project Texture from Side', enabled: hasSelectedFaces, execute: ({ editor }) => editor.projectTexture('side') },
