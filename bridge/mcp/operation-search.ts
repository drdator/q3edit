...
const entries: OperationDiscoveryEntry[] = [
  ...
  { type: 'create_patch', category: 'geometry', summary: 'Create curved bevel, endcap, cylinder, arch, pipe, or ramp patch geometry.', keywords: ['curve', 'curved', 'gothic', 'archway', 'tube'] },
  ...
  { type: 'edit_patches', category: 'materials', summary: 'Edit patch material, projection, transforms, and subdivisions.', keywords: ['curve texture', 'patch uv'] },
